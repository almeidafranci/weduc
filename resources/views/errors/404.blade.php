...
<head>
    ...
    <title>Comunicado Oficial | {{ config('app.name') }}</title>
...
<style>
    ...
    #rocket {
        ...
        animation: launch 5s ease-out forwards;
    }
...
<div class="text-animation">
    <div class="text-animation-center">
        <img style="width: 250px" src="{{url(asset('img/sBotics_Logo_text.png'))}}">
        <h1>Comunicado Oficial</h1>
        <h2>Esta página está sendo mostrada em oposição ao nosso site original devido ao desligamento temporário de
            nossos
            serviços, em antecipação a uma grande atualização planejada para algum momento nos primeiros meses de
            2022.</h2>
        <h3>Nos desejamos a todos um feliz natal e um próspero ano novo, nos vemos normalmente na próxima atualização do
            sBotics, de cara nova e com muito mais funcionalidades.</h3>
        <h4>Equipe sBotics :)</h4>
    </div>
</div>
</body>
</html>
